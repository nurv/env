...
(def-snips (html-mode-abbrev-table html-helper-mode-abbrev-table)
  ...
  ("par"     "<p>$$</p>" "paragraf")
  ("div"     "<div>$$</div>" "div")
  ("divi"    "<div id=\"$${cssid}\">$$</div>" "divi")
  ("divc"    "<div class=\"$${cssclass}\">$$</div>" "divc")
  ("divic"   "<div id=\"$${cssid}\" class=\"$${cssclass}\">$$</div>" "divic")
  ("divci"   "<div id=\"$${cssid}\" class=\"$${cssclass}\">$$</div>" "divci")
  ("pre"     "<pre>$$</pre>" "pre") 
  ("link"    "<a href=\"$${url}\">$$</a>" "preci")
  ("br"      "<br />" "br" "br")
  ("ul"      "<ul>\n\n</ul>" "br")
  ("li"      "<li>$$</li>" "li")
  ("h1"      "<h1>$$</h1" "h1")
  ...
  ("h6"      "<h6>$$</h6" "h6")
  ("id"      " id=\"$${cssid}\"" "id")
  ("class"   " class=\"$${cssclass}\"" "id")
  ("table"   "<table border=\"$${0}\" cellspacing=\"$${0}\" cellpadding=\"$${0}\">\n<tr><th>$${Header}</th></tr>\n<tr><td>$${Data}</td></tr>\n</table>" "table")
  ("tr"      "<tr>\n$$\n</tr>" "tr")
  ("td"      "<td>$$</td>" "td")
  ("th"      "<th>$$</th>" "th")
  ("img"     "<img src=\"$${imgsource}\" />" "img")
  ("doctype" "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\"\n 	\"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">" "doctype_Public")
  ("xmlhead" "<?xml version=\"1.0\" encoding=\"utf-8\"?>" "xmlhead")
...
(global-set-key [(control r)] 'rails-webrick-open-browser)
